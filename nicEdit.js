...
var nicLinkOptions = {
	buttons : {
		'' : {name : 'Add Link', type : 'nicLinkButton', tags : ['A']},
		'' : {name : 'Remove Link',  command : 'unlink', noActive : true}
	}
};
/* END CONFIG */
...
var nicImageOptions = {
	buttons : {
		'' : {name : 'Add Image', type : 'nicImageButton', tags : ['IMG']}
	}
...
var nicUploadOptions = {
	buttons : {
		'' : {name : 'Upload Image', type : 'nicUploadButton'}
	}
